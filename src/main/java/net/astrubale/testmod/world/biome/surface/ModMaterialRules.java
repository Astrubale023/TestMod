package net.astrubale.testmod.world.biome.surface;
    ...
    public static MaterialRules.MaterialRule makeRules() {
        ...
        return MaterialRules.sequence(
                MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(ModBiomes.TEST_BIOME),
                                MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, BLUE_TERRACOTTA)),
                        MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, RED_MUSHROOM_BLOCK)),
